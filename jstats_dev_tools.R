...
#  Claude edits against a single assembled master file (7036Tools.R) that
...
receive_package <- function(file = "7036Tools.R") {
...
assemble_package <- function(out = "7036Tools.R") {
  .jdev_assert_package_root()
